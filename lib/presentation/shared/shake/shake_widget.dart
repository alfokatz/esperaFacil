...
class ShakeWidgetState extends State<ShakeWidget>
  ...
  void initState() {
    ...
    if (widget.shakeConstant.translate.isEmpty) {
      ...
      _translateAnimation = ConstantTween(
        widget.shakeConstant.translate.first,
      ).animate(_controller);
    } else {
    ...
    if (widget.shakeConstant.opacity.isEmpty) {
      ...
      _opacityAnimation = ConstantTween(
        widget.shakeConstant.opacity.first,
      ).animate(_controller);
    } else {
    ...
    if (widget.shakeConstant.rotate.isEmpty) {
      ...
      _rotateAnimation = ConstantTween(
        widget.shakeConstant.rotate.first * 1.0,
      ).animate(_controller);
    } else {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      child:
          widget.autoPlay || widget.enableWebMouseHover == false
              ? widget.child
              : MouseRegion(
