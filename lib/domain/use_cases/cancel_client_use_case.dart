...
class CancelClientUseCase extends BaseUseCase<void, String> {
  final WaitingGroupRepository waitingGroupRepository;

  CancelClientUseCase({required this.waitingGroupRepository});

  @override
  Future<Either<HttpError, void>> call({required String params}) {
    return waitingGroupRepository.cancelWaitingGroup(id: params);
  }
}

final cancelClientUseCase = Provider(
  (ref) => CancelClientUseCase(
